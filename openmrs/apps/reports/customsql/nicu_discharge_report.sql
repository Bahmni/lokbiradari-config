...
p.gender as 'Gender',p.birthdate as 'DOB',bd.bed_number as 'Bed Number',va.date_created as 'Discharge Date' from visit_attribute va
  inner join visit_attribute_type vat on vat.visit_attribute_type_id = va.attribute_type_id
                                         and vat.name='Admission Status'
                                         and cast(va.date_changed as DATE) BETWEEN '#startDate#' and '#endDate#'
