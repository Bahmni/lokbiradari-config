select * from(
Select A.person_id,ANC_Mother_Identifier as ANC_Mother_Identifier ,Age,Birthdate,Gender,Tehsil,District,City_Village,max(A.Delivery_date) as Delivery_date,
max(A.Delivery_Type) as Delivery_Type,A.Mother_Weight as Mother_Weight,max(A.Child_Weight) as Child_Weight from (
SELECT
o.person_id,
